...
public class Countries {
	...
	public static List<String> names() {return names;}// All the names:	
	public static List<String> names(int size) {return new ArrayList<String>(select(size).keySet());}// A partial list:
